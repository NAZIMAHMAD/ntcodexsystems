...
<footer className='bg-black h-auto   flex justify-center items-center py-[3rem] border-gray-700  border-b
'>
...
<img src={logo} alt="logo of ntcodex systems in footer section " title='logo of ntcodex systems in footer section ' className='w-[8rem] h-[5rem] '/>
<p className='pt-[1rem] text-white'>ntcodex systems is the emerging brand in india to make your expection into reality.</p>
