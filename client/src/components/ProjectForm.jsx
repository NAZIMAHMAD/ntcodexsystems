...
<div className=' flex justify-start items-start w-[80%] lg:w-[60%] md:w-[60%] capitalize'>
...
<div className='flex justify-start items-start md:w-[15rem] w-full flex-col capitalize gap-[1rem]'>
...
<div className='flex justify-start items-start md:w-[15rem] w-full capitalize mt-[2rem]'>
